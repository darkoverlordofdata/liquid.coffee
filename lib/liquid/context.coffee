...
module.exports = (Liquid) ->
  ...
  class Context
    ...
    constructor: (assigns, registers, rethrowErrors) ->
      ...
      @strainer = Liquid.Strainer.create(this)
    ...
    merge: (newScope) ->
      ...
      Liquid.extensions.object.update.call @scopes[0], newScope
      ...
      if object
        parts.each (part) ->
          ...
          if squareMatch
            ...
            else if object and typeof (object[part]) is "function" and ["length", "size", "first", "last"].include(part)
