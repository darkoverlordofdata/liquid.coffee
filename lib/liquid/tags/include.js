  ...
  Include = (function(_super) {
    ...
    Include.prototype.render = function(context) {
      var output, partial, source, variable,
        _this = this;
      source = this._readTemplateFromFileSystem(context);
      ...
      context.stack(function() {
        ...
        if (variable instanceof Array) {
          output = variable.map(function(variable) {
            context.set(this.templateName.slice(1, -1), variable);
    ...
    Include.prototype._readTemplateFromFileSystem = function(context) {
      var fileSystem;
      fileSystem = context.registers.fileSystem || Liquid.Template.fileSystem;
      return fileSystem.readTemplateFile(context.get(this.templateName));
    };
